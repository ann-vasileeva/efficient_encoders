...
from models.psp.encoders import transformer
...
class FSEFull(nn.Module):
    ...
    def set_encoder(self):
        ...
        #feat_editor = psp_encoders.ContentLayerDeepFast(6, 1024, 512) # we need to change this and onwards
        feat_editor = transformer.build_stylegan_cond_unet()
    ...
    def forward(self, x, return_latents=False, n_iter=1e5):
        ...
        edited_feat = self.encoder(sample=fused_feat, direction=delta)
