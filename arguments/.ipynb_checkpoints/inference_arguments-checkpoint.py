...
class ExperimentArgs:
    config_dir: str = str("configs")
    config: str = "fse_inference.yaml"
    output_dir: str = "/home/ayavasileva/data/inverted_sfe"
    seed: int = 1
...
@dataclass
class DataArgs:
    inference_dir: str = "/home/ayavasileva/data/Celeba-Test/"
...
class ModelArgs:
    ...
    batch_size: int = 4
    workers: int = 4
    checkpoint_path: str = "/home/ayavasileva/StyleFeatureEditor/pretrained_models/sfe_editor.pt"
