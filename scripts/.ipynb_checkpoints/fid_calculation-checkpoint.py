...
def inferece_fid_editing(opts):
    ...
    if os.path.exists(opts.orig_path + "/.ipynb_checkpoints"):
        subprocess.run(["rm", "-r", opts.orig_path + "/.ipynb_checkpoints"], check=True)
    if os.path.exists(opts.synt_path + "/.ipynb_checkpoints"):
        subprocess.run(["rm", "-r", opts.synt_path + "/.ipynb_checkpoints"], check=True)
    ...
    print(len(attr_dataset) ,len(not_attr_dataset))
